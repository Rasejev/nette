...
class Container_e876099f1b extends Nette\DI\Container
{
	...
	protected $wiring = [
		...
		'App\Presenters\EditPresenter' => [2 => ['application.1']],
		...
		'App\Presenters\PostPresenter' => [2 => ['application.5']],
	...
	public function createServiceApplication__1(): App\Presenters\EditPresenter
	{
		$service = new App\Presenters\EditPresenter($this->getService('database.default.explorer'));
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('database.default.explorer'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	{
		$service = new App\Presenters\PostPresenter($this->getService('database.default.explorer'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('01'),
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('E:\sturma\nette-blog/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('E:\sturma\nette-blog/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_e876099f1b
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=nette-blog', 'root', 'student', []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_e876099f1b $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('E:\sturma\nette-blog/temp/cache/latte');
